 ...
 */
	...
	*/
	 ...
	 * return 闰月数 （月份从1开始）
	 */
	export function getLunarLeapYear(year){
	 ...
	 */
	export function getLunarDateByBetween(year,between){
	 ...
	 * 两个公历日期之间的天数
	 */
	export function getDaysBetweenSolar(year,month,day,year1,month1,day1){
	 ...
	 */
	export function getDaysBetweenZheng(year,month,day){
		var lunarYearDays = getLunarYearDays(year);
		var monthDays = lunarYearDays.monthDays;
		var days = 0;
		for(var i=0;i<monthDays.length;i++){
	 ...
	 */
	export function getYearZodiac(year){
	 ...
	 */
	export function getLunarYearName(year,offset){
		offset = offset || 0;
	 ...
	 */
	export function getLunarMonthName(year,month,offset){
		offset = offset || 0;
	 ...
	 */
	export function getLunarDayName(year,month,day){
		//当日与1890/1/1 相差天数
	 ...
	 */
	export function formateDate(year,month,day,_minYear){
	 ...
	 */
	export function lunarToSolar(_year,_month,_day){
	 ...
	 * @param {Number} year,month,day 公历年，月，日
	 */
	export function solarToLunar(_year,_month,_day){
	 ...
	 */
	export function calendar(_year,_month,fill){
	 ...
	 */
	export function solarCalendar(_year,_month,fill){
		var inputDate = formateDate(_year,_month);
		if(inputDate.error)return inputDate;
		var year = inputDate.year;
		var month = inputDate.month;
	 ...
	 */
	export function setWorktime(workData){
